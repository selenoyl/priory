...
public sealed class GameEngine
{
    ...
    public PlayerOverview GetPlayerOverview()
    {
        ...
        return new PlayerOverview(_state.PlayerName, _state.Sex, _state.LifePath, _state.SelectedClassKey, inventory, _state.Coin, _state.SceneId);
    }
    ...
    private void RunNpcConversation(NpcDef npc, string topic, List<string> lines)
    {
        ...
        {
            lines.Add("You can ask about: work | rumors | faith | schedule | friendship | courtship | propose.");
            lines.Add($"Hint: {npc.Hints[_rng.Next(npc.Hints.Length)]}");
            return;
        }
        ...
        switch (topic)
        {
            ...
            case "rumors":
                lines.Add(stage >= 3
                    ...
                    : "They share restrained gossip, warning you to test every report against charity and truth.");
