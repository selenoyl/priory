...
public sealed class GameEngine
{
    ...
    public EngineOutput HandleInput(string raw)
    {
        ...
        {
            case Intent.Help:
                lines.Add("Commands: look, go <place>, talk <person>, examine <thing>, inventory, save, quit.");
                break;
            case Intent.Look:
    ...
    private TimedPrompt? MaybeActivateTimed(List<string> lines)
    {
        ...
        return new TimedPrompt(timed.Id, timed.Prompt, _state.ActiveTimedDeadline.Value,
