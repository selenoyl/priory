...
`PRIORY` is a Catholic-historical text adventure focused on rebuilding Saint Catherine Priory in medieval Yorkshire.
...
- **Long-form playability**:
  - main questline: revitalizing Saint Catherine
